...
<body class="bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center min-h-screen">
    ...
    <div class="space-x-4">
        @auth
            <a href="{{ url('/dashboard') }}" class="inline-block px-10 py-4 text-lg font-semibold bg-blue-600 text-white rounded-xl shadow-lg hover:bg-blue-700 hover:shadow-2xl hover:-translate-y-1 active:translate-y-0 active:shadow-md transform transition duration-200">Go to Dashboard</a>
        @else
            <a href="{{ route('login') }}" class="inline-block px-10 py-4 text-lg font-semibold bg-blue-600 text-white rounded-xl shadow-lg hover:bg-blue-700 hover:shadow-2xl hover:-translate-y-1 active:translate-y-0 active:shadow-md transform transition duration-200">Log in</a>
